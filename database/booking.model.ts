...
export interface IBooking extends Document {
  ...
  email: string;
  createdAt?: Date; // optional – Mongoose sets via timestamps
  updatedAt?: Date; // optional – Mongoose sets via timestamps
}
...
BookingSchema.pre<IBooking>('save', async function () {
  ...
  // Use exists() – slightly cheaper than findById + select
